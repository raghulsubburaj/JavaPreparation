		...
		if (connection != null) {
			...
			try {
				...
				while (rs.next()) {
					...
					employeeMap.put("FathersName", rs.getString("mothers_name"));
					employeeMap.put("MothersName", rs.getString("address"));
					employeeMap.put("Address", rs.getString("mobile_number"));
